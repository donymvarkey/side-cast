  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 text-gray-100 rounded-lg shadow-lg">
      ...
      <div className="flex items-center gap-4 mb-6">
        <img alt={"sidecast logo"} src={logo_white} className={"size-60"} />
        <div>
      ...
      <p className="mb-6 font-quicksand-regular">
        <strong className="font-quicksand-semibold">SideCast</strong> is a
        lightweight, cross-platform desktop application built with Electron that
        allows you to mirror and interact with your Android devices using ADB
        and scrcpy. It's fast, simple, and completely local — no internet
        required.
      </p>
      ...
      <div className="text-sm text-gray-500 mt-10 border-t border-gray-700 pt-4 font-quicksand-light">
        <p>
          Developed by Dony M Varkey · © {new Date().getFullYear()} SideCast
        </p>
      </div>
    </div>
  );
